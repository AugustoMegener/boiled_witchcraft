...
class DeleteOption : EditorOption<GlyphData, UseInput>(UseInput::class, deleteOption) {
    ...
    override fun onUsed(glyphAuthor: GlyphAuthor, input: UseInput, data: GlyphData, stack: GlyphStack) {
        glyphAuthor.removeComposition(glyphAuthor.compositions.indexOf(stack))
    }
}